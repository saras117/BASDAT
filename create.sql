...
CREATE TABLE KELAS_MK (
	IdKelasMK integer PRIMARY KEY NOT NULL,
...
CREATE TABLE MHS_MENGAMBIL_KELAS_MK(
	...
	IdKelasMK integer REFERENCES KELAS_MK(IdKelasMK),
	Nilai NUMERIC(5,2),
...
CREATE TABLE DOSEN_KELAS_MK (
	...
	IdKelasMK integer REFERENCES KELAS_MK(IdKelasMK) NOT NULL,
...
CREATE TABLE LOG(
	...
	ID_kat_log INTEGER REFERENCES KATEGORI_LOG(id),
	ID_st_log INTEGER REFERENCES STATUS_LOG(id),
